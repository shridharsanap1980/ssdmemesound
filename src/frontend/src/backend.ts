...
import type { ExternalBlob as _ExternalBlob, Sound as _Sound, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addSound(arg0: string, arg1: string, arg2: Array<string>, arg3: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addSound(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteSound(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteSound(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSounds(): Promise<Array<Sound>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSounds();
    ...
    async getMostPlayedSounds(arg0: bigint): Promise<Array<Sound>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMostPlayedSounds(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSound(arg0: bigint): Promise<Sound> {
        if (this.processError) {
            try {
                const result = await this.actor.getSound(arg0);
                return from_candid_Sound_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async incrementPlayCount(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async searchSoundsByTag(arg0: string): Promise<Array<Sound>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchSoundsByTag(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchSoundsByTags(arg0: Array<string>): Promise<Array<Sound>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchSoundsByTags(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAudioBlob(arg0: bigint, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAudioBlob(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSound(arg0: bigint, arg1: string, arg2: string, arg3: Array<string>, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSound(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Sound_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Sound): Promise<Sound> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        audioBlob: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.audioBlob),
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Sound>): Promise<Array<Sound>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Sound_n12(_uploadFile, _downloadFile, x)));
}
